...
- Unzip the file.
- Using an FTP client (I recommend FireZilla), upload the 'fotographia' file to your WordPress theme folder. Make sure the file you upload simply says 'fotographia' with no numbers after it. Otherwise, it won't work.
...
= Liquid Slider License =
Liquid Slider is licensed under the MIT license. http://www.opensource.org/licenses/mit-license.php
...
Cardo-Regular.ttf: Copyright (c) 2002-2011, David J. Perry (hospes02@scholarsfonts.net)
Cardo-Italic.ttf: Copyright (c) 2002-2011, David J. Perry (hospes02@scholarsfonts.net)
Cardo-Bold.ttf: Copyright (c) 2002-2011, David J. Perry (hospes02@scholarsfonts.net)
